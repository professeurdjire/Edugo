...
const Color _purpleMain = AppConst.purpleButton; // Violet principal (couleur principale)
const Color _colorBlack = Color(0xFF000000); // Texte noir
const Color _colorChallenge = Color(0xFFFFA500); // Orange pour "Nouveau Challenge"
const Color _colorQuiz = AppConst.purpleButton; // Violet pour "Quiz"
const Color _colorDefi = AppConst.successGreen; // Vert pour "Nouveau défi"
