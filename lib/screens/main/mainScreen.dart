        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              _navItem(Icons.menu_book, "Bibliothèque", 1, primaryColor),
              _navItem(Icons.emoji_events, "Challenge", 2, primaryColor),
              _navItem(Icons.fitness_center, "Exercice", 3, primaryColor),
              _navItem(Icons.smart_toy, "Assistance", 4, primaryColor),
            ],
          ),
        ),
      ),
